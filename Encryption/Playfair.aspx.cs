...
{
    public partial class Playfair : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string result = Encipher(input, input2);
            ...
            Response.Write("<script>alert('The Encrypted string equals : " + result1 + "')</script>");
            TextBox1.Text = "";
            TextBox2.Text = "";
        }
    }
